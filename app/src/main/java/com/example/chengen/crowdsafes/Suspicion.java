...
public class Suspicion extends Fragment implements View.OnClickListener {
    ...
    private final static String Url = "https://www.crowdsafes.com/reportSuspicion";
    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        View v = inflater.inflate(R.layout.activity_suspicion, container, false);
        getActivity().getWindow().setSoftInputMode(WindowManager.LayoutParams.SOFT_INPUT_STATE_ALWAYS_HIDDEN);
        reportDescription = (EditText) v.findViewById(R.id.etSusp);
    ...
    private void OnSendButtonPress(){
        ...
        if (sharedPref.contains("suspicionLoc"))
            target = sharedPref.getString("suspicionLoc","");
    ...
    public void onPause() {
        ...
        Thread t = new Thread(){
            ...
            public void run() {
                super.run();
                SharedPreferences sharedPref = getActivity().getSharedPreferences("susupicion", Context.MODE_PRIVATE);
